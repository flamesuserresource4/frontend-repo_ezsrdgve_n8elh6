...
export default function Hero3D() {
  return (
    <section id="home" className="relative h-[88vh] min-h-[560px] w-full overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(255,255,255,0.6),transparent_60%),radial-gradient(ellipse_at_bottom,rgba(255,255,255,0.6),transparent_60%)]" />
      ...
      <div className="relative z-10 h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
        <div className="max-w-2xl bg-white/60 backdrop-blur-md rounded-2xl p-6 sm:p-8 shadow-lg">
          ...
          <h1 className="mt-2 text-3xl sm:text-5xl font-bold tracking-tight">
            Hi, I’m Flames — I craft modern web experiences
          </h1>
          <p className="mt-4 text-sm sm:text-base text-gray-700">
            A blend of performance, aesthetics, and delightful interactions. Explore selected work and reach out if you’d like to collaborate.
          </p>
